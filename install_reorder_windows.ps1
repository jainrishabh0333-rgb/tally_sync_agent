...
# exercises the same code path the scheduled run will take. Verifying a
# different configuration than the one being scheduled is not verification.
...
rem .1 and started fresh. A daily job left for a year would otherwise leave a
